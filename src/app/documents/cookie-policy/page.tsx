      ...
      <main className={styles.page}>
        <article className={styles.content}>
          ...
          <section className={styles.section}>
            ...
            <p>
              Cookie позволяют сделать сайт удобнее и надёжнее, а также
              собирать обезличенную статистику посещений. Мы не используем
              cookie, чтобы скрыто собирать лишние данные сверх того, что нужно
